...
const Megaliti = () => {
  return (
    <>
      ...
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">
        Obiskovalci pogosto začnejo svoj obisk z opazovanjem sončnega vzhoda na Žusmu, nato pa se odpravijo na voden ogled petih lokacij megalitov. V okviru <a className="link" target="_blank" rel="noopener" title="Društvo izviri Dobrina" href="https://www.izviri-dobrina.si/">Društva Izviri Dobrina</a>, kjer deluje sekcija Megaliti Žusma, prirejajo različne dejavnosti za skupine, povezane s praznovanji prastarih praznikov, kot so solsticiji in ekvinokciji. Tako na primer ob pomladanskem enakonočju izvajajo ženski in moški krog, med poletnim sončnim obratom pa prirejajo dogodke, posvečene družinam, z naslovom "Občutim megalite Žusma". 
      </p>
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">
        Za tiste, ki jih zanima podrobnejša zgodovina in pomen megalitov na Žusmu, je na voljo knjiga "Nove zgodbe Žusma" avtorice Andreje Križan Lipnik. Knjiga je na voljo v <a className="link" target="_blank" rel="noopener" title="Turistično informacijski center Šentjur" href="https://www.turizem-sentjur.com/">Turistično informacijskem centru Šentjur</a> ali po naročilu. 
      </p>
      <p className="text-textColor dark:text-darkOnSurface">
      <br></br>
