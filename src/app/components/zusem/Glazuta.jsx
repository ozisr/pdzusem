...
const Glazuta = () => {
  return (
    <>
      ...
      <br></br>
      <p>Vir: <a className="link" href="https://www.pokmuz-ce.si/sl/razstave/zunanje-razstave/glazute-na-obmocju-zusma-cerkvica-sv-leopold-loka-pri-zusmu/" target="_blank" rel="noopener" title="Spletn stran Pokrajinskega muzeja Celje je vir informacij o glažuti">Pokrajinski muzej Celje</a></p>
    </>
  )
};
