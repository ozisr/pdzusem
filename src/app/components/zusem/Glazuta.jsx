...
const Glazuta = () => {
  return (
    <>
      ...
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">
        Johann Friedrich, lastnik glažute Sveti Jurij ob Taboru v gospostvu Ojstrica, je 24. junija 1836 prosil za dovoljenje, da postavi glažuto v kraju Loka v okrožju Žusem. V vlogi je zapisal, da so na tem območju pred tem delovale že tri steklarne. Po prejetju dovoljenja jo je postavil ob potoku Žamerk, voda pa je poganjala tudi brusilni mlin in dva drobilca proda. Sklenil je tudi pogodbo o sečnji lesa z grofom Harbuval Chamarom; pogodba je bila vknjižena v zemljiško knjigo 6. februarja 1837. Po njej je bilo dovoljeno letno posekati v gozdovih žusemske gospoščine kar 85.000 klafter lesa, kar je pomenilo letno 1.062 klafter cepljenih drv ter dodatno še 195 klafter v gozdu v Vodolah.
      </p>
      <figure>
        <Image
        src="/images/vsebina/steklarna1.jpg"
        alt="Steklena majolka izdelana v loški glažuti"
        width={400}
        height={400}
        className="m-auto"
        />
        <figcaption className="caption">Slika: Primer izdeleka loške glažute</figcaption>
      </figure>
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">
      ...
      <figure>
        <Image
        src="/images/vsebina/stekleni_lestenec.jpg"
        alt="Primer steklenega lesteneca, kakršnih veliko najdemo v okoliških cerkvah"
        width={400}
        height={400}
        className="m-auto"
        />
        <figcaption className="caption">Slika: Stekleni cerkveni lestenec</figcaption>
      </figure>
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">
      ...
      <br></br>
      <p className="text-textColor dark:text-darkOnSurface">Vir: <a className="link" href="https://www.pokmuz-ce.si/sl/razstave/zunanje-razstave/glazute-na-obmocju-zusma-cerkvica-sv-leopold-loka-pri-zusmu/" target="_blank" rel="noopener" title="Spletn stran Pokrajinskega muzeja Celje je vir informacij o glažuti">Pokrajinski muzej Celje</a></p>
    </>
  )
};

export default Glazuta;